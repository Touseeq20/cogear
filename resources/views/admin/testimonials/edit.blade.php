...
<div class="max-w-4xl px-4">
    <div class="mb-8 flex items-center">
        ...
        <h3 class="text-2xl font-bold text-slate-800">Edit Client Review: {{ $testimonial->client_name }}</h3>
    </div>
        ...
        <form action="{{ route('admin.testimonials.update', $testimonial) }}" method="POST" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
                <div>
                    ...
                    <input type="text" name="client_name" value="{{ old('client_name', $testimonial->client_name) }}" required class="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-600 transition">
                ...
                <div>
                    ...
                    <input type="text" name="company" value="{{ old('company', $testimonial->company) }}" class="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-600 transition">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="message" rows="5" required class="w-full px-5 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-4 focus:ring-blue-100 focus:border-blue-600 transition">{{ old('message', $testimonial->message) }}</textarea>
